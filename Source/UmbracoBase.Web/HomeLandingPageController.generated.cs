...
namespace UmbracoBase.Web.Controllers.RenderMvcControllers
{
    public partial class HomeLandingPageController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeLandingPageController Actions { get { return MVC.HomeLandingPage; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "HomeLandingPage";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "HomeLandingPage";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeLandingPageController : UmbracoBase.Web.Controllers.RenderMvcControllers.HomeLandingPageController
    {
        public T4MVC_HomeLandingPageController() : base(Dummy.Instance) { }
